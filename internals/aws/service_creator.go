...
// CredentialCreator is an implementation of the secretone.Verifier and secretone.Encrypter interface that can be used
...
func (c CredentialCreator) Wrap(plaintext []byte) (*api.EncryptedData, error) {
	...
	//fmt.Println("enc CiphertextBlob:",base64.StdEncoding.EncodeToString(resp.CiphertextBlob))
