	...
	cases := map[string]struct {
		...
		"success gcp": {
			req: CreateCredentialRequest{
				...
				Verifier:    []byte("service-account@secretone-test-1234567890.iam.gserviceaccount.com"),
				Proof:       &CredentialProofGCPServiceAccount{},
				Metadata: map[string]string{
					CredentialMetadataGCPServiceAccountEmail: "service-account@secretone-test-1234567890.iam.gserviceaccount.com",
					CredentialMetadataGCPKMSKeyResourceID:    "projects/secretone-test-1234567890.iam/locations/global/keyRings/test/cryptoKeys/test",
				},
			},
			err: nil,
		},
		...
		"gcp wrong verifier": {
			req: CreateCredentialRequest{
				Type:        CredentialTypeGCPServiceAccount,
				Fingerprint: "9380691f0735ac4d2df25b856d80a06a0d8d93e318dbc6b5464c0bb14c2d1668",
				Verifier:    []byte("another-service-account@secretone-test-1234567890.iam.gserviceaccount.com"),
				Proof:       &CredentialProofGCPServiceAccount{},
				Metadata: map[string]string{
					CredentialMetadataGCPServiceAccountEmail: "service-account@secretone-test-1234567890.iam.gserviceaccount.com",
					CredentialMetadataGCPKMSKeyResourceID:    "projects/secretone-test-1234567890.iam/locations/global/keyRings/test/cryptoKeys/test",
