...
// User represents a secretone user.
type User struct {
	...
	TenantCode    string    `json:"tenant_code,omitempty"`    //租户代码，仅用户生成backupcode
	...
	CreatedAt     string    `json:"created_at,omitempty"`     // Optional, private information is only returned for yourself
	LastLoginAt   string    `json:"last_login_at,omitempty"`  // Optional, private information is only returned for yourself
}
