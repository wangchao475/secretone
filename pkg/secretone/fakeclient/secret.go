...
var _ secretone.SecretService = (*SecretService)(nil)

// SecretService is a mock of the SecretService interface.
type SecretService struct {
	VersionService     secretone.SecretVersionService
...
func (s *SecretService) EventIterator(path string, config *secretone.AuditEventIteratorParams) secretone.AuditEventIterator {
	return s.AuditEventIterator
}

// Versions returns a mock of the VersionService interface.
func (s *SecretService) Versions() secretone.SecretVersionService {
