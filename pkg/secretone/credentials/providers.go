...
type Provider interface {
	Provide(*http.Client) (auth.Authenticator, Decrypter, string, error)
}
...
func (k KeyProvider) Provide(httpClient *http.Client) (auth.Authenticator, Decrypter, string, error) {
...
type providerFunc func(*http.Client) (auth.Authenticator, Decrypter, string, error)

// Provide lets providerFunc implement the Provider interface.
func (f providerFunc) Provide(httpClient *http.Client) (auth.Authenticator, Decrypter, string, error) {
	return f(httpClient)
}
