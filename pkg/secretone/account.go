...
// AccountService handles operations on secretone accounts.
...
func (c *Client) createAccountKeyRequest(encrypter credentials.Encrypter, accountKey crypto.SM2PrivateKey) (*api.CreateAccountKeyRequest, error) {
...
func (c *Client) createCredentialRequest(encrypter credentials.Encrypter, accountKey crypto.SM2PrivateKey, verifier credentials.Verifier, metadata map[string]string) (*api.CreateCredentialRequest, error) {
...
func (c *Client) getAccountKey() (*crypto.SM2PrivateKey, error) {
	if c.accountKey == nil {
...
func (c *Client) fetchAccountDetails() error {
	...
	if resp.EncryptedPrivateKey == nil {
		return errors.New("get nil EncryptedPrivateKey")
	}
	...
	accountKey, err := crypto.ImportSM2PrivateKeyPEM(data)
	if err != nil {
		return errio.Error(err)
	}
